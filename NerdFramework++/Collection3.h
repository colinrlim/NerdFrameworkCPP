...
public:
    ...
    Collection3(List<T*>&& objects) : _data(std::move(objects)), _origin(Vector3::zero), _scale(Vector3::one) { }
    Collection3(std::vector<T*>&& objects) : _data(std::move(objects)), _origin(Vector3::zero), _scale(Vector3::one) { }
